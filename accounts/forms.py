...
class CRMUserCreateForm(UserCreationForm):
    class Meta(UserCreationForm.Meta):
        model = User
        fields = ("username", "first_name", "last_name", "email", "role", "phone", "reports_to")
...
class CRMUserEditForm(forms.ModelForm):
    class Meta:
        model = User
        fields = ("first_name", "last_name", "email", "role", "phone", "reports_to", "is_active_employee", "is_active")
...
class CRMUserRegisterForm(UserCreationForm):
    ...
    ], initial=User.Role.COUNSELLOR, required=True)
