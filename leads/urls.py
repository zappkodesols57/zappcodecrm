...
urlpatterns = [
    ...
    path("team-history/<int:user_id>/analysis/", views.user_performance_analysis, name="user_performance_analysis"),
    ...
    path("hospital-configuration/export/excel/", views.export_hospital_config_excel, name="hospital_config_export_excel"),
    path("hospital-configuration/export/pdf/", views.export_hospital_config_pdf, name="hospital_config_export_pdf"),
    ...
    path("bulk-transfer/", views.bulk_lead_transfer, name="bulk_lead_transfer"),
]
